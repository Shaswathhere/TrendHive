      ...
      <div className="w-full max-w-md animate-scale-in">
        ...
        <Card className="p-8 bg-white dark:bg-[#13102a] border border-[#e0e0f0] dark:border-[#2d2a50] shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgot-password" className="text-xs text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 font-medium transition-colors">
                  Forgot?
                </Link>
              </div>
              <Input
          ...
          <p className="text-center text-[#6b7280] mt-6 text-sm">
            ...
            <Link to="/signup" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 font-semibold transition-colors">
              Sign Up
            </Link>
          </p>
        </Card>
        ...
        <p className="text-center text-[#6b7280] text-xs mt-5">
          ...
          <Link to="/terms" className="underline hover:text-indigo-600 transition-colors">Terms</Link>{" "}and{" "}
          <Link to="/privacy" className="underline hover:text-indigo-600 transition-colors">Privacy Policy</Link>
        </p>
      </div>
    </div>
  )
